...
class ConvertDocumentsOptions(BaseModel):
    ...
    asr_pipeline_model: Annotated[
        Optional[asr_model_specs.AsrModelType],
        Field(
            description="Preset Whisper model for the ASR pipeline. Auto-selects best implementation for hardware (MLX on Apple Silicon, native elsewhere).",
            examples=[
                asr_model_specs.AsrModelType.WHISPER_TURBO,
                asr_model_specs.AsrModelType.WHISPER_SMALL,
            ],
        ),
    ] = None
